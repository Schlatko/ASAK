...
/**
 * SEO-optimierte SpritzServices (Variante Kanal) Komponente
 * @param {string} serviceImg - Pfad zum Hintergrundbild
 * @param {string} altText - SEO Alt-Text (entsprechend der Masterliste im Canvas)
 */

const SpritzServices = forwardRef(({ serviceImg, altText, title, tagline }, ref) => {
const { t } = useTranslation('spritzservices');

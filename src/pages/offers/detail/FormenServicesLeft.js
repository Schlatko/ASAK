...
/**
 * SEO-optimierte FormenServices (Variante Kanal) Komponente
 * @param {string} serviceImg - Pfad zum Hintergrundbild
 * @param {string} altText - SEO Alt-Text (entsprechend der Masterliste im Canvas)
 */
const FormenServicesKanal = forwardRef(({ serviceImg, altText, title, tagline }, ref) => {
  const { t } = useTranslation('formenserviceskanal');
...
export default FormenServicesKanal;